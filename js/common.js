...
$(".header__bottom a").click(function() {
	...
	$('.slider-catalog').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		prevArrow: '<div class="slick-prev slick-arrow"><i class="far fa-long-arrow-left"></i>Предыдущий<div/>',
		nextArrow: '<div class="slick-next slick-arrow">Следующий<i class="far fa-long-arrow-right"></i><div/>',
	});
	...
	$('.slider-partners').slick({
		...
		slidesToScroll: 1,
		prevArrow: '<div class="slick-prev slick-arrow"><i class="far fa-long-arrow-up"></i><div/>',
		nextArrow: '<div class="slick-next slick-arrow"><i class="far fa-long-arrow-down"></i><div/>',
		responsive: [{
			breakpoint: 992,
			settings: {
				vertical: false,
